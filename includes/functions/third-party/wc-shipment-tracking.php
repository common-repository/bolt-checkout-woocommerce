 ...
 *
 * Functions to support WooCommerce Shipment Tracking.
 * Tested up to: 1.6.20
 *
 ...
 *
 */
function record_tracking_number( $mid, $order_id, $meta_key, $_meta_value ) {
...
add_action( 'updated_postmeta', '\BoltCheckout\record_tracking_number', 10, 4 );
add_action( 'added_post_meta', '\BoltCheckout\record_tracking_number', 10, 4 );
